<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('area_info')">导出</a-button>
    ...
    <areaInfo-modal ref="modalForm" @ok="modalFormOk"></areaInfo-modal>
  </a-card>
</template>
...
<script>
  ...
  import AreaInfoModal from './modules/AreaInfoModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/mng/areaInfo/rootList",
          childList: "/mng/areaInfo/childList",
          getChildListBatch: "/mng/areaInfo/getChildListBatch",
          delete: "/mng/areaInfo/delete",
          deleteBatch: "/mng/areaInfo/deleteBatch",
          exportXlsUrl: "/mng/areaInfo/exportXls",
          importExcelUrl: "mng/areaInfo/importExcel",
        },
        expandedRowKeys:[],
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'areaCode',text:'区域code,街道和区code一致',dictCode:''})
