<template>
  <div class="p-4">
    ...
    <!--字典弹窗-->
    <AreaInfoModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="mng-areaInfo" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, useTable, TableAction} from '/src/components/Table';
  import {useModal} from '/src/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import AreaInfoModal from './components/AreaInfoModal.vue';
  import {columns} from './AreaInfo.data';
  import {list, deleteAreaInfo, batchDeleteAreaInfo, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './AreaInfo.api';
  ...
  async function handleDelete(record) {
    await deleteAreaInfo({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteAreaInfo({ids: ids}, importSuccess);
  }
  /**
   * 导入
   */
