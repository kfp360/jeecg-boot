package org.jeecg.modules.demo.mng.vo;
 ...
 */
@Data
@ApiModel(value="constrPage对象", description="constr")
public class ConstrPage {
	...
	@ExcelCollection(name="constr_area")
	@ApiModelProperty(value = "constr_area")
	private List<ConstrArea> constrAreaList;
	@ExcelCollection(name="constr_attach")
	@ApiModelProperty(value = "constr_attach")
	private List<ConstrAttach> constrAttachList;
	@ExcelCollection(name="constr_street")
	@ApiModelProperty(value = "constr_street")
	private List<ConstrStreet> constrStreetList;
